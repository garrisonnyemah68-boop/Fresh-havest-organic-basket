        ...
        <Box pb={"70px"}>
            ...
            <Box >
                <Box
                    ...
                    alignItems={"center"}
                    maxWidth={"1200px"}
                    p={{ xs: "40px 20px 80px", md: "60px 40px 120px", lg: "60px 0 120px" }}
                    marginRight={"auto"}
                    marginLeft={"auto"}
                >
                    <Box width={{ xs: "100%", md: "50%" }} m={{ xs: "0 0 32px 0", md: "0 80px 0 0" }} p={"10px"}>
                    ...
                    <Box p={"10px"} display={{ xs: "none", md: "block" }} width={{ md: "50%" }}>
            ...
            <Box padding={"30px"} bgcolor={"#111111"} display={"flex"} gap={2} >
                ...
                >
                    <Box width={{ xs: "100%", md: "300px" }} textAlign={{ xs: "center", md: "left" }}>
                        <Typography variant='h4' color={"#ffffff"}>Numbers Speak For Themselves!</Typography>

                    </Box>
                    <Box width={{ xs: "40%", md: "200px" }} textAlign={{ xs: "center", md: "left" }}>
