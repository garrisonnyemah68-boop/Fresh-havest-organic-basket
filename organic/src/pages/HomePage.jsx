...
const FeatureCard = ({ icon, mainText, text }) => {
  return (
    <Box
      ...
      flex={1}
      gap={"15px"}
      sx={{ p: { xs: "20px 16px", sm: "25px 20px", md: "35px 25px" } }}
      bgcolor={"#333333"}
      alignItems={"center"}
    >
      {icon}
...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      <Box
        sx={{
          padding: { xs: "30px 16px", sm: "40px 24px", md: "60px 40px", lg: "80px" },
          bgcolor: "#111111",
          display: "grid",
      ...
      <Box bgcolor={"#fff"} p={"140px 0 50px"}>
        <Box maxWidth={"1200px"} mx={"auto"} px={{ xs: "20px", md: "40px", lg: 0 }}>
          <Box
            display={"flex"}
            flexDirection={"column"}
            gap={"20px"}
          ...
          <Box padding={"70px 0"}>
            <Box
              ...
              sx={{ gridColumnGap: "20px", gridRowGap: "30px" }}
            >
      ...
      <Box bgcolor={"#111111"} py={"60px"} px={{ xs: "20px", md: "40px" }}>
        <Box
          maxWidth={"1100px"}
          mx={"auto"}
          display={"flex"}
      ...
      >
        ...
        <img src={logo1} style={{ width: "120px", height: "auto" }} />
        <img src={logo2} style={{ width: "120px", height: "auto" }} />
        <img src={logo3} style={{ width: "120px", height: "auto" }} />
        <img src={logo4} style={{ width: "120px", height: "auto" }} />
        <img src={logo5} style={{ width: "120px", height: "auto" }} />
      </Box>
    </div>
  );
};
